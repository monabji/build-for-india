...
export function HomePage() {
  return <>
    <section className="home-intro"><div className="container">
      <p className="eyebrow">A simpler citizen journey</p>
      <h1>How can we help you today?</h1>
      <p className="lead">Choose what you need. You do not need to know department terms or which form comes first.</p>
    </div></section>
    <div className="container page-section">
      <div className="task-grid" aria-label="Choose a task">
        <TaskCard to="/apply" title="Apply for a UDID card">See what you need and start a guided application.</TaskCard>
        <TaskCard to="/track" title="Track my application">See the latest status, next action and timeline.</TaskCard>
        <TaskCard to="/applications/correction/correct" title="Fix a rejected application">Understand the problem and replace only what is needed.</TaskCard>
        <TaskCard to="/renew" title="Renew my card">Check the demo requirements and start a renewal.</TaskCard>
        <TaskCard to="/replace" title="Replace a lost or damaged card">Get a clear replacement route without starting over.</TaskCard>
        <TaskCard to="/documents/certificate" title="Download my certificate">Open a synthetic certificate and save a copy.</TaskCard>
      </div>
