...
const baseDraft = (name: string): ApplicantDraft => ({
  ...
  address: '42 Example Road, Demo Ward',
  ...
  identityDocument: 'Synthetic identity proof.pdf',
  addressDocument: 'Synthetic address proof.pdf',
  authorityId: 'auth-1',
  consent: true,
})
...
const event = (
  ...
  description,
  occurredAt,
  actorLabel: userActionRequired ? 'Applicant' : 'Demo service',
  userActionRequired,
  nextAction,
})
...
export const authorities: Authority[] = [
  {
    id: 'auth-1',
    name: 'District Medical Centre — Demo Central',
    district: 'Demo District',
    state: 'Maharashtra',
    address: '12 Service Road, Demo Central, 400001',
    accessNotes: 'Step-free entrance, accessible toilet and sign-language support by request.',
    contactLabel: 'Prototype contact route only',
  },
  {
    id: 'auth-2',
    name: 'Community Assessment Centre — Demo North',
    district: 'Demo North',
    state: 'Delhi',
    address: '8 Citizen Avenue, Demo North, 110001',
    accessNotes: 'Ramp access, quiet waiting area and wheelchair available.',
    contactLabel: 'Prototype contact route only',
  },
  {
    id: 'auth-3',
    name: 'Regional Medical Board — Demo East',
    district: 'Demo East',
    state: 'West Bengal',
    address: '25 Public Service Lane, Demo East, 700001',
...
export const createSeedScenarios = (): Record<ScenarioId, ApplicationRecord> => {
  ...
  return {
    new: {
      id: 'UDID-DEMO-20481', applicantName: 'Anita Sharma', mode: 'SELF', serviceType: 'NEW',
    ...
    correction: {
      id: 'UDID-DEMO-31842', applicantName: 'Rohan Verma', mode: 'CAREGIVER', serviceType: 'NEW',
      ...
      timeline: [
        ...
        event('cor-2', 'DOCUMENT_REVIEW', 'Document review started', 'The demo reviewing office began checking the documents.', '23 August 2026, 11:10'),
        event('cor-1', 'SUBMITTED', 'Application submitted', 'The application was received with synthetic documents.', '21 August 2026, 14:05'),
      ],
    ...
    appointment: {
      id: 'UDID-DEMO-42715', applicantName: 'Meena Das', mode: 'SELF', serviceType: 'NEW',
      currentStatus: 'ASSESSMENT_SCHEDULED', currentNextAction: 'Attend the synthetic assessment appointment.', completionPercent: 92,
      ...
      appointment: { id: 'APT-DEMO-104', date: '4 September 2026', time: '10:30 AM', locationName: 'District Medical Centre — Demo Central', address: '12 Service Road, Demo Central, 400001', accessNotes: 'Step-free entrance. Arrive 20 minutes early. This appointment is synthetic.', status: 'UPCOMING' },
      timeline: [
        event('apt-3', 'ASSESSMENT_SCHEDULED', 'Medical assessment scheduled', 'A synthetic appointment has been added to this application.', '25 August 2026, 10:30', true, 'Attend the appointment on 4 September at 10:30 AM.'),
        event('apt-2', 'DOCUMENT_REVIEW', 'Documents checked', 'The submitted documents passed the demo review.', '22 August 2026, 15:40'),
        event('apt-1', 'SUBMITTED', 'Application submitted', 'The application was received.', '16 August 2026, 12:10'),
      ],
      notifications: [{ id: 'note-apt', title: 'Assessment appointment scheduled', body: 'Your synthetic appointment is on 4 September at 10:30 AM.', createdAt: '25 August 2026, 10:30', read: false }],
    },
    approved: {
      id: 'UDID-DEMO-53906', applicantName: 'Imran Khan', mode: 'SELF', serviceType: 'NEW',
      currentStatus: 'CARD_DISPATCHED', currentNextAction: 'Download the synthetic certificate or view card dispatch details.', completionPercent: 100,
      ...
      timeline: [
        event('app-6', 'CARD_DISPATCHED', 'Prototype card dispatched', 'A synthetic dispatch reference has been created.', '27 August 2026, 08:45'),
        event('app-5', 'CERTIFICATE_GENERATED', 'Certificate ready', 'The synthetic certificate is available to download.', '26 August 2026, 17:30'),
        event('app-4', 'APPROVED', 'Application approved in demo', 'The seeded demo decision was recorded. This is not an official approval.', '26 August 2026, 14:00'),
        event('app-3', 'MEDICAL_ASSESSMENT', 'Synthetic assessment completed', 'The demo medical assessment stage was completed.', '22 August 2026, 13:00'),
        event('app-2', 'DOCUMENT_REVIEW', 'Documents checked', 'The documents passed the demo review.', '8 August 2026, 11:20'),
        event('app-1', 'SUBMITTED', 'Application submitted', 'The application was received.', '2 August 2026, 09:10'),
      ],
      notifications: [{ id: 'note-approved', title: 'Synthetic certificate ready', body: 'You can now download the prototype certificate.', createdAt: '26 August 2026, 17:30', read: false }],
    },
  }
}
